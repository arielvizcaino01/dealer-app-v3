/*
  ...
  - A unique constraint covering the columns `[userId]` on the table `BusinessSettings` will be added. If there are existing duplicate values, this will fail.

*/
-- AlterTable
ALTER TABLE "BusinessSettings" ADD COLUMN     "userId" TEXT;
